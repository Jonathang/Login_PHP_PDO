    ...
    <div class="container-fluid fondo">
        <div class="d-flex">
            <div class="card card-total mb-3" style="max-width: 840px;">
                <div class="row g-0">
                    <div class="card-body">
                        <h2 class="card-title text-center">Registrar Nuevo Estudiante</h2> <!-- titulo formulario -->
                        ...
                        <form action="../controlador/codigoregistrate.php" method="post" id="formulario">
                            ...
                            <div class="input-group flex-nowrap my-4">
                                <span class="input-group-text formulario-registrate" id="addon-wrapping"><img
                                        src="../icons/person_black_24dp.svg"></span>
                            ...
                            <div class="input-group flex-nowrap my-4">
                                ...
                                <input type="password" class="form-control" placeholder="Password" aria-label="Pass"
                                    aria-describedby="addon-wrapping" name="pass" id="pass">
